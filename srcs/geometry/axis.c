...
/*   Updated: 2021/11/16 13:41:53 by sotherys         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_bool	ft_geometry_axis(t_geometry *axis)
{
	...
	ft_geometry_add_point(axis, (t_point){(t_vector3){1, 0, 0}, 0xFFFF0000});
	ft_geometry_add_point(axis, (t_point){(t_vector3){0, 0, 0}, 0xFF00FF00});
	ft_geometry_add_point(axis, (t_point){(t_vector3){0, 1, 0}, 0xFF00FF00});
	ft_geometry_add_point(axis, (t_point){(t_vector3){0, 0, 0}, 0xFF0000FF});
	ft_geometry_add_point(axis, (t_point){(t_vector3){0, 0, 1}, 0xFF0000FF});
